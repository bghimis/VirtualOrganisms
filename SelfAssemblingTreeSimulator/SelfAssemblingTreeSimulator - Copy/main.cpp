...
int main()
{
	...
	{
		simulator.simulateOptimalVsRandomFlowScenario(g_numOptimalScenarioSimulations, g_simulateOptimalVsRandomFlowSampleCount, g_simulationTicksForDataFlowEstimation, 
													  g_avgTickBetweenSourceEvents, g_ticksToDelayDataFlowCaptureOnRestructure);
	}
